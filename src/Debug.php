...
class Debug
{
    ...
    public static function createException(
        ...
        // If we have no StringException child class, we assume the default Exception class constructor is used
        if (!\in_array(StringException::class, \class_parents($exceptionClass)) && $exceptionClass !== StringException::class) {
            /**
        ...
        /**
         * @var StringException $exception At this point we know that $exceptionClass inherits from DBException for sure
         */
        $exception = new $exceptionClass(
